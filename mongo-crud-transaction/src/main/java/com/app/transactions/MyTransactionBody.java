...
public class MyTransactionBody implements TransactionBody<String> {
    private String globalName;
    private MongoClient client;
    private ClientSession clientSession;

    public MyTransactionBody(String globalName, MongoClient client, ClientSession clientSession) {
